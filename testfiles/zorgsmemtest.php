...
<div class="container-fluid">
  <div class="row content" >
    ...
    <h1 class="panel-heading">Organizations</h1>
      ...
      <a href="orgrg.php">
      <button type="button" class="btn btn-primary" style="font-size:24px;">Register Your Organization</button>
      </a>
      
      <a href="memreg.php">
      <button type="button" class="btn btn-success" style="font-size:24px;">Add a Member</button>
      </a>
...
<div class="col-sm-4">
<div class="well well-sm alert-warning" style="max-height:500px; min-height:500px; overflow-y:auto;">
<h3>{$row["oName"]}</h3>
<hr>
<img src="{$image}" width="175px" height="175px" class="img-circle img-fluid center-block"></img>
Description: {$row["oDescription"]}
<br><br>
Category: {$row["oCategory"]}
<br><br>
Website: <a href="http://{$row["oWebsite"]}">{$row["oWebsite"]}</a>
<br><br>
Meeting: {$row["oMeetingTime"]}
